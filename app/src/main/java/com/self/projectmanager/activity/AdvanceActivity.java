...
public class AdvanceActivity extends Activity {
    ...
    public void add(View view) {
        ...
        if (StringUtils.isEmpty(balanceStr)) {
            Toast.makeText(this, "支取金额不能为空", Toast.LENGTH_LONG).show();
            return;
        }

        if (StringUtils.isEmpty(dateStr)) {
            Toast.makeText(this, "支取日期不能为空", Toast.LENGTH_LONG).show();
            return;
        }
