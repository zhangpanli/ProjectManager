...
import com.self.projectmanager.fragment.ProjectDetailFragment;
...
public class ProjectDetailActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.project_detail_main);
    ...
    private void initView() {
        ProjectDetailFragment tab01 = new ProjectDetailFragment();
        MemberMainFragment tab02 = new MemberMainFragment();
